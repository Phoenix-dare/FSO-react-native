...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent("1.6 k");
      expect(firstRepositoryItem).toHaveTextContent("21.9 k");
      ...
      expect(secondRepositoryItem).toHaveTextContent("1.8 k");
